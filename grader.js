...
var checkHtmlFile = function(htmlfile, checksfile) {
    htmlstring = cheerioHtmlFile(htmlfile);
    console.log(htmlstring);
    return checkString(htmlstring, checksfile);
};

var checkUrl = function(url, checksfile) {
      result = restler.get(url).on('complete', function(result) { 
      ...
      checkJson = checkHtmlFile("out.html", checksfile);
